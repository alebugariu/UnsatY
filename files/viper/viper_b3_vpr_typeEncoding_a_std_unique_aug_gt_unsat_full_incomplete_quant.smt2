...
(set-info :boogie-vc-id benchmark3)
...
(assert (! (not (IsPredicateField NormalFieldType intType val)) :named A65))
(assert (! (not (IsWandField NormalFieldType intType val)) :named A66))
(assert (! (= (ControlFlow 0 0) 5393) :named A67_0))
(assert (! (= (ControlFlow 0 5393) 3282) :named A67_1))
(assert (! (= ZeroMask Mask@@9) :named A67_2))
(assert (! (or (and (= (ControlFlow 0 3282) 3299) (state Heap@@9 ZeroMask) (forall ((i_1py0 Int)(j_1py0 Int)) (! (or (not (<= 0 i_1py0)) (<= j_1py0 i_1py0) (<= (Seq@sharp@Length intType xs) j_1py0) (= (U_2_int (Seq@sharp@Index intType xs i_1py0)) (U_2_int (Seq@sharp@Index intType xs j_1py0)))) :pattern ((Seq@sharp@Index intType xs i_1py0) (Seq@sharp@Index intType xs j_1py0)) )) (or (and (= (ControlFlow 0 3299) 3316) (state Heap@@9 ZeroMask) (forall ((i$0_1py0 Int)(j$0_1py0 Int)) (! (or (not (<= 0 i$0_1py0)) (<= j$0_1py0 i$0_1py0) (<= (Seq@sharp@Length intType ys) j$0_1py0) (= (U_2_int (Seq@sharp@Index intType ys i$0_1py0)) (U_2_int (Seq@sharp@Index intType ys j$0_1py0)))) :pattern ((Seq@sharp@Index intType ys i$0_1py0) (Seq@sharp@Index intType ys j$0_1py0)) )) (= (Seq@sharp@Length intType xs) (Seq@sharp@Length intType ys)) (= (ControlFlow 0 3316) 3322) (forall ((x_1py0 T@U)) (! (or (not (Seq@sharp@Contains intType xs x_1py0)) (Seq@sharp@Contains intType ys x_1py0)) :pattern ((Seq@sharp@ContainsTrigger intType ys x_1py0)) :pattern ((Seq@sharp@Contains intType ys x_1py0)) )) (= (ControlFlow 0 3322) (- 5624)) (not (Seq@sharp@Equal intType xs ys))) (and (= (ControlFlow 0 3299) 3310) (<= 0 i$0) (not (<= j$0 i$0)) (not (<= (Seq@sharp@Length intType ys) j$0)) (or (and (= (ControlFlow 0 3310) (- 5659)) (not (<= 0 i$0))) (and (<= 0 i$0) (or (and (= (ControlFlow 0 3310) (- 5665)) (<= (Seq@sharp@Length intType ys) i$0)) (and (not (<= (Seq@sharp@Length intType ys) i$0)) (or (and (= (ControlFlow 0 3310) (- 5673)) (not (<= 0 j$0))) (and (<= 0 j$0) (= (ControlFlow 0 3310) (- 5679)) (<= (Seq@sharp@Length intType ys) j$0)))))))))) (and (= (ControlFlow 0 3282) 3293) (<= 0 i@@6) (not (<= j@@5 i@@6)) (not (<= (Seq@sharp@Length intType xs) j@@5)) (or (and (= (ControlFlow 0 3293) (- 5739)) (not (<= 0 i@@6))) (and (<= 0 i@@6) (or (and (= (ControlFlow 0 3293) (- 5745)) (<= (Seq@sharp@Length intType xs) i@@6)) (and (not (<= (Seq@sharp@Length intType xs) i@@6)) (or (and (= (ControlFlow 0 3293) (- 5753)) (not (<= 0 j@@5))) (and (<= 0 j@@5) (= (ControlFlow 0 3293) (- 5759)) (<= (Seq@sharp@Length intType xs) j@@5))))))))) :named A67_3))
(assert (! (state Heap@@9 ZeroMask) :named A67_4))
(check-sat)
(get-info :reason-unknown)
;z3 -T:600 group_007/ematching/tmp/b3.vpr-typeEncoding-a_std_unique_aug-gt_unsat-full.smt2
;unknown
